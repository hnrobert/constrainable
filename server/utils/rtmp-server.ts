 ...
 * The standard port 1935 is omitted; remapped ports live in
 * PUBLIC_RTMP_AUTHORITY (per-node). Per-viewer node
...
export function guideRtmpServer(h3Event: H3Event): string {
  ...
  // standard port 1935 (omitted) — remapped ports belong in
  // PUBLIC_RTMP_AUTHORITY, which the client-side assignment overrides with
